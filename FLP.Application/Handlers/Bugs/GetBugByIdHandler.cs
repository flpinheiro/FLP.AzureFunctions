...
public class GetBugByIdHandler(IUnitOfWork _uow, IMapper _mapper, ILogger<GetBugByIdHandler> _logger) : IRequestHandler<GetBugByIdRequest, GetBugByIdResponse>
{
    /// <summary>
